...
const UserHome = () => {
    ...
    return (
        <div className="min-h-screen bg-transparent pb-10">
            ...
            {!initialSearch && (
                <div className="relative text-white overflow-hidden mx-auto w-[98%] max-w-[1700px] rounded-3xl mb-8 shadow-xl">
            ...
            {initialSearch && (
                <div className="max-w-[1500px] mx-auto px-4 mt-8 mb-8 animate-fadeIn">
                    <h1 className="text-center text-3xl font-medium text-black mb-8">Search results</h1>



                    {/* Filter Bar */}
                    <div className="flex flex-col md:flex-row justify-between items-center pb-4 gap-4 text-sm text-gray-700">
                        {/* Left: Filters */}
                        ...
                        <div className="flex items-center gap-8">
                            <div className="flex items-center gap-2">
                                <span>Sort by:</span>
                                <div className="flex items-center gap-1 cursor-pointer font-medium hover:text-black">
                                    <span>Relevance</span>
                                    <ChevronDown size={14} />
                                </div>
                            </div>
